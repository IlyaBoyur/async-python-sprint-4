...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_db_shortened_url_created_at"),
        "db_shortened_url",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_db_shortened_url_use_created_at"),
        "db_shortened_url_use",
        ["created_at"],
        unique=False,
    )
